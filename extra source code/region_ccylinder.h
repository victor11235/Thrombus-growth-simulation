...
RegionStyle(ccylinder,RegCcylinder)

#else

#ifndef LMP_REGION_CCYLINDER_H
#define LMP_REGION_CCYLINDER_H

#include "region.h"

namespace LAMMPS_NS {

class RegCcylinder : public Region {
  friend class FixPour;

 public:
  RegCcylinder(class LAMMPS *, int, char **);
  ~RegCcylinder();
  void init();
